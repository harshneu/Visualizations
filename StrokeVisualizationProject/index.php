...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="back-normal.html">Data-Info</a></li>
...
<section style="margin-left: 50px">
    <div class="center">
        <div class="hex hex-1" >
            <div class="hex-a">
                <div class="hex-b" style="background-image:url('images/back1.png');"></div>
            </div>
        </div>
        <div class="hex">
            <div class="hex-a">
                <div class="hex-b"  style=" background-image: url('images/back2.png')" ></div>
            </div>
        </div>
        <div class="hex">
            <div class="hex-a">
                <div class="hex-b"  style=" background-image: url('images/back3.png')" ></div>
            </div>
        </div>
        <div class="hex">
            <div class="hex-a">
                <div class="hex-b"  style=" background-image: url('images/back4.png')" ></div>
            </div>
        </div>
        <div class="hex">
            <div class="hex-a">
                <div class="hex-b"  style=" background-image: url('images/back5.png')" ></div>
            </div>
        </div>
        <div class="hex">
            <div class="hex-a">
                <div class="hex-b"  style=" background-image: url('images/back6.png')" ></div>
            </div>
        </div>
        <div class="hex" >
            <div class="hex-a">
...
<h1>PlaceHolder for project Description</h1>
<h1>Placeholder for youtube Tool tutorial</h1>
    <footer>Copyright &copy; Northeastern University</footer>
